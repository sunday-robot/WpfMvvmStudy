...
namespace IdealAppStudy
{
    ...
    /// such as those commonly used in UI frameworks. Property values are automatically converted to uppercase when set.
    /// The ChangeNameRandomly method can be used to assign random values to one of the name properties.</remarks>
